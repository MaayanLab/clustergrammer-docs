...
Clustergrammer2 is an interactive heatmap Jupyter widget built using the widget-ts-cookiecutter library and the WebGL library `regl`_. Clustergrammer2 is built to help researchers interactively explore single cell data (e.g. scRNA-seq). Please see :ref:`case_studies` for examples.
...
.. _`issues`: https://github.com/ismms-himc/clustergrammer2/issues
.. _`gitter`: https://gitter.im/clustergrammer2/community?source=orgpage
