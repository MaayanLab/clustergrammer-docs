...
Use Cases
=========
Clustergrammer was built to visualize biological data, but is also applicable for visualizing high-dimensional data in general. Below are links to several example use cases (see :ref:`case_studies` for more information):
